...
public class MainFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            //lấy att từ Servletcontext và gán vào một map
            Map<String, String> map = (Map<String, String>) context.getAttribute("LINK");
            ...
            log("Error at MainFilter_Servlet: " + t.getMessage());
        } catch (IOException t) {
            log("Error at MainFilter_IO: " + t.getMessage());
        }
    }
