...
public class ViewHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                if (userdto != null) {
                    ...
                    for (BillDTO billDTO : list) {
                        ...
                        DiscountDTO discountDTO = discountDAO.getDiscountByBillId(billDTO.getBillId());
                        if(discountDTO!=null){
                            billDTO.setDiscountCode(discountDTO);
                        }
                    }
            ...
            log("Error at ViewHistoryContoller_SQL: " + e.getMessage());
        } catch (NamingException e) {
            log("Error at ViewHistoryContoller_Naming: " + e.getMessage());
        } finally {
